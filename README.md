...
To run this game, make sure you have ```npm```, ```node```, ```git```, and ```mongo``` installed. Then, clone this repo. Once you have the repo, run ```npm install``` to fetch all the dependencies. 
